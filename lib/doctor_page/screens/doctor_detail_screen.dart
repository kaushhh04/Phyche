        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Row(
                children: <Widget>[
                  Image.asset('asset/image/doctor_pic2.png', height: 220),
                  SizedBox(
                    width: 20,
                  ),
                  Container(
                          ...
                          children: <Widget>[
                            InkWell(
                              ...
                              child: IconTile(
                                ...
                                imgAssetPath: "asset/image/email.png",
                              ),
                            ),
                            InkWell(
                              onTap: () async {
                                await launch('tel:+91 8355803664');
                              },
                              child: IconTile(
                                backColor: Color(0xffFFECDD),
                                imgAssetPath: "asset/image/call.png",
                              ),
                            ),
                            IconTile(
                              backColor: Color(0xffEBECEF),
                              imgAssetPath: "asset/image/video_call.png",
                            ),
                          ],
                        )
                      ],
                ...
                children: <Widget>[
                  Column(
                    children: <Widget>[
                      Row(
                        children: <Widget>[
                          Image.asset("asset/image/mappin.png"),
                          SizedBox(
                            width: 20,
                          ),
                          Column(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Container(
                              ...
                              child: Image.asset("asset/image/list.png")),
                          SizedBox(
                            width: 16,
                          ),
                          Container(
